...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* QWERTY */
    ...
    KC_CTLZ, KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,  KC_COMM, KC_DOT,  KC_CTTA,
                                 KC_GUTA, KC_BSNUM, KC_ENNAV, KC_SPALT
  ),

  [_NAV] = LAYOUT( 
    KC_TAB,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_LBRC,
    KC_LSFT, KC_LGUI, KC_RALT, KC_ESC,  KC_TRNS,         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RBRC, 
    KC_LCTL, KC_TRNS, KC_BTN1, KC_BTN2, KC_TRNS,         KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_QUOT,
                                    KC_DEL, KC_TRNS,  _______, KC_TRNS  
  ),
