...
*/
  [_NAV] = LAYOUT( 
   ...
   KC_LCTL, KC_CAPS, KC_DEL,  KC_BSPC,  KC_ENT,         KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_QUOT,
...
_FUN Layer 
,-------------------.             ,-------------------. 
|TAB|   |   |   |SPC|             |   | F7| F8| F9|F10|
|---+---+---+---+---|             |---+---+---+---+---| 
|LSH|LGU|LAL|RAL|ESC|             |F12| F4| F5| F6|RSH|
|-------+---+---+---|             |---+---+---+---+---| 
|LCL|   |   |   |ENT|             |F11| F1| F2| F3|RCL| 
`---+---+---+---+---+---.     ,---+---+---+---+---+---' 
                |   |   |     |   |   | 
		`-------'     `-------'	               
*/
[_LMOD] = LAYOUT(
    KC_TAB,  _______, _______, _______,  KC_SPC,         _______,   KC_F7,   KC_F8, KC_F9, KC_F10,
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT,  KC_ESC,         KC_F12,    KC_F4,   KC_F5, KC_F6, KC_RSFT,
    KC_LCTL, _______, _______, _______,  KC_ENT,         KC_F11,    KC_F1,   KC_F2, KC_F3, KC_RCTL,
                               _______, _______,         _______, _______  
  )
};
