...
*/
  [_NUM] = LAYOUT(
    KC_TAB,  KC_NUBS, KC_GRV,  _______, KC_SPC,        KC_EQL,   KC_7, KC_8, KC_9, KC_0,
...
SE-WIN
,-------------------.             ,-------------------. 
|TAB|hlf|MB1|MB2|SPC|             |HME|PDN|PUP|END| [{| 
|---+---+---+---+---|             |---+---+---+---+---| 
|LSH|LGU|LAL|RAL|ESC|             |LFT|DWN|LFT|RGT| ;:|
|-------+---+---+---|             |---+---+---+---+---| 
|LCL|CAP|DEL|BSP|ENT|             |ML |MDN|MUP|MR | '"| 
...
_FUN Layer 
,-------------------.             ,-------------------. 
|APP| F7| F8| F9|F10|             |SPC|   |   |   |TAB| 
|---+---+---+---+---|             |---+---+---+---+---|
|CPL| F4| F5| F6|F11|             |ESC|RAL|LAL|RGU|RSH|
|-------+---+---+---|             |---+---+---+---+---|
|INS| F1| F2| F3|F12|             |MWL|MWD|MWU|MWR|RCL|             
`---+---+---+---+---+---.  ,---+--+---+---+---+---+---' 
                |   |   |  |   |  | 
		`-------'  `------'                    
*/
[_FUN] = LAYOUT(
    KC_APP,  KC_F7, KC_F8, KC_F9, KC_F10,                 KC_SPC,  _______, _______, _______, KC_TAB,           
    KC_CAPS, KC_F4, KC_F5, KC_F6, KC_F11,                 KC_ESC,  KC_RALT, KC_LALT, KC_RGUI, KC_RSFT,
    KC_INS,  KC_F1, KC_F2, KC_F3, KC_F12,                 KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_RCTL,          
                              _______, _______,           _______, _______
  ),
