...
|-------+---+---+---|             |---+---+---+---+---| 
|LCL| Z |DEL|BSP|ENT|             |ML |MDN|MUP|MR | '"| 
`---+---+---+---+---+---.     ,---+---+---+---+---+---' 
                |   |   |     |   |   | 
		`-------'     `-------'		 
*/
  [_NAV] = LAYOUT( 
    ...
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT,  KC_ESC,         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, 
...
*/
  [_NUM] = LAYOUT(
    KC_TAB, KC_GRV, KC_VOLD, KC_VOLU, KC_MUTE,        KC_EQL,  KC_7, KC_8, KC_9, KC_0,
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT, KC_ESC,         KC_MINS, KC_4, KC_5, KC_6, KC_RBRC,
    KC_LCTL, _______, _______, _______, KC_ENT,         KC_NUBS,  KC_1, KC_2, KC_3, KC_SLSH, 
...
_FUN Layer 
,-------------------.             ,-------------------. 
|MOD|HUI|SAI|VAI|TOG|             |APP| F7| F8| F9|F10| 
|---+---+---+---+---|             |---+---+---+---+---|
|LSH|LGU|LAL|RAL|ESC|             |CPL| F4| F5| F6|F11| 
|-------+---+---+---|             |---+---+---+---+---|
|LCL|MUT|VDN|VUP|ENT|             |INS| F1| F2| F3|F12| 
`---+---+---+---+---+---.  ,---+--+---+---+---+---+---' 
                |   |   |  |   |  | 
		`-------'  `------' 
*/
...
*/
  [_NUMPAD] = LAYOUT(
    ...
    KC_LCTL, KC_PCMM, KC_PDOT, KC_PENT, KC_NLCK,         KC_PPLS, KC_KP_1, KC_KP_2, KC_KP_3, KC_PSLS, 
                                 _______, _______,     _______, _______
		     )
