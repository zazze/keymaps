...
#define KC_LGUS LGUI_T(KC_S)
#define KC_LALD LALT_T(KC_D)
#define KC_RALF RALT_T(KC_F)
#define KC_LCTLZ LCTL_T(KC_Z)

#define KC_LALJ LALT_T(KC_J)
#define KC_RALK RALT_T(KC_K)
#define KC_RGUL RGUI_T(KC_L)
#define KC_RSHSH RSFT_T(KC_NUHS)
#define KC_RCTLBSP RCTL_T(KC_BSP)
...
|---+---+---+---+---|             |---+---+---+---+---| 
| A | S | D | F | G |             | H | J | K | L | #~|
|LSH|LGU|LAL|RAL|   |             |   |LAL|RAL|RGU|RSH|
|-------+---+---+---|             |---+---+---+---+---| 
| Z | X | C | V | B |             | N | M | ,<| .>|BSP|
|LCL|   |   |   |   |             |   |   |   |   |RCL| 
`---+---+---+---+---+----.    ,---+---+---+---+---+---'
...
[_QWERTY] = LAYOUT(
    ...
    KC_LSHA,  KC_LGUS, KC_LALD, KC_RALF, KC_G,            KC_H,    KC_LALJ, KC_RALK, KC_RGUL, KC_RSHSH,
    KC_LCTLZ, KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_RCTLBSP,
