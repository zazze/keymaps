...
[_QWERTY] = LAYOUT(
    ...
    KC_Z,      KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,  KC_COMM, KC_DOT,  KC_RCTLzzzzBSP,
...
*/
  [_NUM] = LAYOUT(
    KC_TAB,   KC_GRV, KC_LBRC, KC_RBRC, KC_SPC,        KC_EQL,   KC_7, KC_8, KC_9, KC_0,
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT, KC_ESC,        KC_MINS,  KC_4, KC_5, KC_6, KC_BSLS,
    KC_LCTL, _______, KC_VOLD, KC_VOLU, KC_ENT,        KC_TILDE, KC_1, KC_2, KC_3, KC_SLSH, 
