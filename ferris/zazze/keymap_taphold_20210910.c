...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT(
    ...
    KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT,         KC_GRV,  KC_1, KC_2, KC_3, KC_SLSH,
  ...
  [_FUN] = LAYOUT(
    ...
    KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT,          KC_INS,  KC_F1, KC_F2, KC_F3, KC_F12,
