...
_NAV Layer 
,-------------------.             ,-------------------. 
|TAB| §±|MB1|MB2|ESC|             |HME|PDN|PUP|END| [{| 
|---+---+---+---+---|             |---+---+---+---+---| 
|LSH|LGU|LAL|RAL|SPC|             |LFT|DWN|LFT|RGT| ;:|
|-------+---+---+---|             |---+---+---+---+---| 
...
*/
  [_NAV] = LAYOUT( 
    KC_TAB,  KC_NUBS, KC_BTN1, KC_BTN2,  KC_ESC,         KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_LBRC,
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT,  KC_SPC,         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_SCLN,
...
[_LMOD] = LAYOUT(
    KC_TAB,  _______, _______, _______,  KC_ESC,         _______, _______, _______, _______, _______,
    KC_LSFT, KC_LGUI, KC_LALT, KC_RALT, KC_BSPC,         _______, _______, _______, _______, _______,
...
*/
[_RMOD] = LAYOUT(
    _______, _______, _______, _______, _______,         KC_ESC, _______, _______, _______, KC_TAB,
    _______, _______, _______, _______, _______,         KC_SPC, KC_LALT, KC_RALT, KC_RGUI, KC_RSFT,
