...
#define KC_LSHSCLN LSFT_T(KC_SCLN)
#define KC_LSHA LSFT_T(KC_A)
#define KC_LSHA LSFT_T(KC_A)
#define KC_LSHA LSFT_T(KC_A)
#define KC_LSHA LSFT_T(KC_A)
...
,-------------------.             ,-------------------. 
|TAB| ` | §°| '*| / |             | ´`|7/||8([|9)]|0= | 
|---+---+---+---+---|             |---+---+---+---+---| |LSH|LGU|LAL|RAL|ESC|             | +?|4€ |5 %|6& |¨^~| |-------+---+---+---|             |---+---+---+---+---| |LCT| & |VOD|VOU|ENT|             | <>|1! |2"@|3# |-_ | `---+---+---+---+---+---.    ,----+---+---+---+---+---' |   |   |    |_FUN|_NUMPAD| `-------'    `------------'		 */ [_NUM] = LAYOUT( KC_TAB,  KC_PLUS, KC_NUBS, KC_BSLS, KC_AMPR,       KC_EQL,   KC_7, KC_8, KC_9, KC_0, KC_LSFT, KC_LGUI, KC_LALT, KC_RALT, KC_ESC,        KC_MINS,  KC_4, KC_5, KC_6, KC_RBRC, KC_LCTL, KC_CIRC, KC_VOLD, KC_VOLU, KC_ENT,        KC_GRV,   KC_1, KC_2, KC_3, KC_SLSH, _______, _______,      MO(_FUN), MO(_NUMPAD)), /* _NAV Layer EN-MAC ,-------------------.             ,-------------------.  |TAB| §±|MB1|MB2|SPC|             |HME|PDN|PUP|END| [{| |---+---+---+---+---|             |---+---+---+---+---| |LSH|LGU|LAL|RAL|ESC|             |LFT|DWN|LFT|RGT| ;:| |-------+---+---+---|             |---+---+---+---+---| 
