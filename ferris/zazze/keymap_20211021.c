...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_Z_LCTL, KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,  KC_COMM, KC_DOT,  KC_BSP_RCTL,
  ...
  [_NAV] = LAYOUT( 
    ...
    KC_LCTL,    KC_Z, KC_BTN1, KC_BTN2,  KC_ENT,         KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_QUOT,
                                   KC_BSPC, KC_DEL,     _______, _______
		   ),

  [_NUM] = LAYOUT(
    _______, KC_NUHS, KC_NUBS, _______, _______,        KC_EQL,  KC_7, KC_8, KC_9, KC_0,
