 ...
 * |---+---+---+---+---+---| DEL|    |BSP|---+---+---+---+---+-------|
 * |LCL| Z | X | C | V | B |----|    |---| N | M | ,<| .>| /?|RSH/ENT|
 * `-----------------------/RAL/      \RAL\--------------------------'
 * (Up|Dn)|Rsh|LAL|LGU|LOW/ENT/        \ENT\RSE|SPC|RGU|RALT|(WL|WR)
 *        `--–––-------------'          `---–---------------'
 */
 ...
 [_QWERTY] = LAYOUT(
    ...
    KC_LCTRL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_DEL,   KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_ENT),
                     KC_LCTRL,  KC_LALT, KC_LGUI, LOWER, RALTENT,  RALTENT, RAISE,   KC_SPC,  KC_RGUI, KC_RALT
),
 ...
 * |LCL|   |   |   |   |   |----|    |---| ` | _ | + | = | - |RSH/ENT|
 * `-----------------------/RAL/      \RAL\--------------------------'
 * (Up|Dn)|Rsh|LAL|LGU|LOW/ENT/        \ENT\RSE|SPC|RGU|RALT|(BSP|DEL)
 *        `--–––-------------'          `---–---------------'
 */

[_LOWER] = LAYOUT(
    KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
    KC_TAB,   KC_F11,  KC_F12,  _______, _______, _______,                   _______, KC_TILD, KC_BSLS, KC_NUBS, _______, _______, 
    KC_LSFT,  _______, _______, _______, KC_CAPS, _______,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
    KC_LCTRL, _______, _______, _______, _______, _______, _______, _______, KC_GRV,  KC_UNDS, KC_PLUS, KC_EQL,  KC_MINS, RSFT_T(KC_ENT),
 ...
 * |---+---+---+---+---+---|             |---+---+---+---+---+-------|
 * |LSH|CPL|   |   |   |   |----.    ,---|LFT|DWN| UP|RGT|ScL|       |
 * |---+---+---+---+---+---| DEL|    |BSP|---+---+---+---+---+-------|
 * |LCL|   |   |   |   |   |----|    |---|   |   |   |   |   |RSH/ENT|
 * `-----------------------/RAL/      \RAL\--------------------------'
 * (Up|Dn)|Rsh|LAL|LGU|LOW/ENT/        \ENT\RSE|SPC|RGU|RALT|(MWU|MWD)
 *        `--–––-------------'          `---–---------------'
 */
...
[_RAISE] = LAYOUT(
  ...
  KC_LCTRL, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, RSFT_T(KC_ENT),
                     _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______
),
 ...
 * |   |    |    |    |   |   |----|    |---|    |    |    |   |   |RSH/ENT|
 * `--------------------------/RAL/      \RAL\-----------------------------'
 *    (Up|Dn)|Rsh|LAL|LGU|LOW/ENT/        \ENT\RSE|SPC|RGU|(RALT)
 *               `--------------'          '--------------'
 */
