...
[_LOWER] = LAYOUT(
    ...
    KC_TAB,   KC_EXLM, KC_PLUS, KC_GRV,  KC_RCBR, KC_AMPR,                     KC_EQL, KC_PEQL, KC_PDOT, XXXXXXX,  KC_F12,  KC_AT,
    KC_LSFT,  KC_HASH, KC_DLR,  KC_LSFT, KC_RALT, KC_PIPE,                     KC_MINS, KC_PMNS, KC_PPLS, KC_NUBS, KC_RBRC, KC_BSLS,
    KC_LCTRL, KC_PERC, KC_CIRC, KC_TILD, KC_RPRN, KC_UNDS, KC_CAPS,   KC_DEL,  KC_NUBS, KC_PSLS, KC_PAST, KC_PENT, KC_SLSH, RSFT_T(KC_ENT),
