...
`-----------+---+---+---+---+---|  |---+---+---+---+---+-----------'
            |Rsh|GUI|LAl| L2|Ent|  |Ent| L1|Spc|RSh|App|
            `-------------------'  `-------------------'
 */
   [_QWERTY] = LAYOUT( 
//,- ------+-----+-----+------+-----+------.                                ,-------+-------+--------+-------+--------+--------.  
...
//,------------------------------------------------|------| |-------|-------|-------|-------|--------|-------+--------+--------,  
                    KC_LSFT,KC_LGUI,KC_LALT,MO(_L2),KC_ENT,   KC_ENT,MO(_L1), KC_SPC,KC_RSFT,  KC_APP
//                 |-------+-------+-------+-------+------, `-------+-------|-------|-------|--------|
		    ),

/*
* _L1: Function keys, navigation
,-----------------------.                  ,-------------------------.
...
/* 
* _L2: Function keys, Symbols, Numbers
,-----------------------.                  ,-----------------------.
| `~| ! | @ | { | } | & |                  | =+| 7&| 8*| 9(| 0)| ]}|
|---+---+---+---+---+---|                  |---+---+---+---+---+---|
|   | # | $ | ( | ) | | |                  | * | 4$| 5%| 6^| + | \||
|---+---+---+---+---+---|-------.  ,-------|---+---+---+---+---+---|
|RAl| % | ^ | [ | ] | _ | \||   |  |   |Del| . | 1!| 2@| 3#| -_|RCl|
`-------------------------------|  |---+---+---+---+---+-----------'
            |   |   |   |   |   |  |PEn|   |   |   |   |
            `-------------------'  `-------------------'
*/
...
//,-------|-------|-------|-------|-------|-------|-------|-------|  |-------|-------|-------+-----+-----+-----+-------+-------|
   KC_RALT,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_UNDS,KC_NUBS,_______,   _______, KC_DEL,KC_PDOT, KC_1, KC_2, KC_3,KC_MINS,KC_RCTL,
//,-------+-------+-------|-------|-------|-------|-------|-------|  |-------|-------|-------|-----------------+-------+-------|
...
layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, _L2, _L1, _MACROS);
}
