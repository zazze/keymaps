...
|---+---+---+---+---+---+-------.  ,---+---+---+---+---+---+---+---|
|LCl| Z | X | C | V | B |RAl|App|  |Del|Bsp| N | M | ,<| .>| /?|RSh|
`-----------+---+---+---+---+---|  |---+---+---+---+---+-----------'
    (Up|Dwn)|Rsh|GUI|LAl|NUM|Esc|  |Ent|NAV|Spc|RAl|Bsp|(Bsp|Del)
            `-------------------'  `-------------------'
 */
[_QWERTY] = LAYOUT( 
//,- ------+-----+-----+------+-----+------.                                  ,-------+-------+--------+-------+--------+--------.  
...
//,--------|-----|-----|------|-----|------|--------+------. ,-------+--------|-------|-------|--------|-------|--------|--------|   
    KC_LCTL, KC_Z, KC_X,  KC_C, KC_V,  KC_B, KC_RALT,KC_APP,   KC_DEL, KC_BSPC,   KC_N,   KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
//,-------------------------------------------------|------| |-------|--------|-------|-------|--------|-------+--------+--------,  
                    KC_RSFT,KC_LGUI,KC_LALT,MO(_NUM),KC_ESC,   KC_ENT,MO(_NAV), KC_SPC,KC_RALT, KC_BSPC
//                 |-------+-------+-------+--------+------, `-------+--------|-------|-------|--------|
		    ),
...
[_NAV] = LAYOUT(
//|-------+-------+-------+-------+-------+-------|                                  |-------+-------+-------+-------+---------+---------|
   _______,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F,                                    KC_HOME,KC_PGDN,KC_PGUP, KC_END,   KC_INS,  KC_PSCR,
//,-------|-------|-------|-------|-------|-------|                                  |-------+-------+-------+-------+---------+---------|
...
[_NUM] = LAYOUT(
//|-------+-------+-------+-------+-------+-------|                                  |--------+-----+-----+-----+-------+-------|
   _______,KC_EXLM,  KC_AT,KC_LCBR,KC_RCBR,KC_AMPR,                                     KC_EQL, KC_7, KC_8, KC_9,   KC_0,KC_RBRC,
//,-------|-------|-------|-------|-------|-------|                                  |--------+-----+-----+-----+-------+-------|
   _______,KC_HASH, KC_DLR,KC_LPRN,KC_RPRN,KC_PIPE,                                    KC_PAST, KC_4, KC_5, KC_6,KC_PPLS,KC_BSLS,
//,-------|-------|-------|-------|-------|-------|-------|-------|  |-------|-------|--------+-----+-----+-----+-------+-------|
   _______,KC_PERC,KC_CIRC,KC_GRV,KC_NUBS,KC_UNDS,_______,_______,   KC_RGUI, KC_DEL,KC_TILDE, KC_1, KC_2, KC_3,KC_MINS,KC_RCTL,
//,-------+-------+-------|-------|-------|-------|-------|-------|  |-------|-------|--------|-----------------+-------+-------|
