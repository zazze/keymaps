...
|---+---+---+---+---+---+-------.  ,---+---+---+---+---+---+---+---|
|LCl| Z | X | C | V | B |GUI|App|  |RAl|Bsp| N | M | ,<| .>| /?|RCl|
`-----------+---+---+---+---+---|  |---+---+---+---+---+-----------'
    (Up|Dwn)|Rsh|Esc|LAl|NUM|Ent|  |Ent|NAV|Spc|RSh|App|(Bsp|Del)
            `-------------------'  `-------------------'
 */
   [_QWERTY] = LAYOUT( 
//,- ------+-----+-----+------+-----+------.                                  ,-------+-------+--------+-------+--------+--------.  
...
//,--------|-----|-----|------|-----|------|--------+------. ,-------+--------|-------|-------|--------|-------|--------|--------|   
    KC_LCTL, KC_Z, KC_X,  KC_C, KC_V,  KC_B, KC_LGUI,KC_APP,  KC_RALT, KC_BSPC,   KC_N,   KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RCTL,
//,-------------------------------------------------|------| |-------|--------|-------|-------|--------|-------+--------+--------,  
                    KC_LSFT, KC_ESC,KC_LALT,MO(_NUM),KC_ENT,   KC_ENT,MO(_NAV), KC_SPC,KC_RSFT, KC_BSPC
//                 |-------+-------+-------+--------+------, `-------+--------|-------|-------|--------|
		    ),
