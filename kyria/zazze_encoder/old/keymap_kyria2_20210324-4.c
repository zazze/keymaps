...
[_LOWER] = LAYOUT(
//|-------+-------+-------+-------+-------+-------|                                  |-------+-----+-----+-----+-------+-------|
  KC_TILDE,KC_EXLM,  KC_AT,KC_LCBR,KC_RCBR,KC_AMPR,                                    KC_GRV, KC_7, KC_8, KC_9,   KC_0,KC_RBRC,
//,-------|-------|-------|-------|-------|-------|                                  |-------+-----+-----+-----+-------+-------|
   _______,KC_HASH, KC_DLR,KC_LPRN,KC_RPRN,KC_PIPE,                                   KC_PAST, KC_4, KC_5, KC_6, KC_EQL,KC_NUBS,
//,-------|-------|-------|-------|-------|-------|-------|-------|  |-------|-------|-------+-----+-----+-----+-------+-------|
   KC_RALT,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_UNDS,_______,_______,   _______, KC_DEL,KC_PDOT, KC_1, KC_2, KC_3,KC_MINS,KC_RCTL,
//,-------+-------+-------|-------|-------|-------|-------|-------|  |-------|-------|-------|-----------------+-------+-------|
