...
,-----------------------.                  ,-------------------------.
|F1 |F2 |F3 |F4 |F5 |F6 |                  |Hme|PgD|PgU|End|ENC3|ENC4|
|---+---+---+---+---+---|                  |---+---+---+---+----+----|
|F7 |F8 |F9 |F10|F11|F12|                  |Lft|Dwn| Up|Rgt|ENC1|ENC2|
|---+---+---+---+---+---+-------.  ,-------+---+---+---+---+----+----|
...
[_RAISE] = LAYOUT(
//|-------+-------+-------+-------+-------+-------|                                      |-------+-------+-------+-------+---------+---------|
     KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5, KC_F6,                                        KC_HOME,KC_PGDN,KC_PGUP, KC_END,MO(_ENC3),MO(_ENC4),
//,-------|-------|-------|-------|-------|-------|                                      |-------+-------+-------+-------+---------+---------|
     KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,                                       KC_LEFT,KC_DOWN,  KC_UP,KC_RGHT,MO(_ENC1),MO(_ENC2),
//,-------|-------|-------|-------|-------|-------|-----------|-------|  |-------|-------|-------+-------+-------+-------+---------+---------|
   KC_MPRV,KC_MPLY,KC_MNXT,KC_MUTE,KC_VOLD,KC_VOLU,    KC_CAPS, KC_INS,   _______,_______,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,  KC_BTN1,  KC_BTN2,
//,-------+-------+-------|-------|-------|-------|-----------|-------|  |-------|-------|-------|-------|-------|-------+---------+---------|
                           _______,_______,_______,MO(_MACROS),_______,   _______,_______,_______,_______,_______
//                        |-------+-------+-------+-----------+-------|  |-------+-------+-------+-------+-------|
		       ),
