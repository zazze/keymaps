...
[_LOWER] = LAYOUT(
//|-------+-------+-------+-------+-------+-------|                                  |-------+-----+-----+-----+-------+-------|
    KC_GRV,KC_EXLM,  KC_AT,KC_LCBR,KC_RCBR,KC_AMPR,                                   KC_PAST, KC_7, KC_8, KC_9,   KC_0,KC_PPLS,
//,-------|-------|-------|-------|-------|-------|                                  |-------+-----+-----+-----+-------+-------|
   _______,KC_HASH, KC_DLR,KC_LPRN,KC_RPRN,KC_PIPE,                                   KC_PSLS, KC_4, KC_5, KC_6, KC_EQL,KC_PMNS,
//,-------|-------|-------|-------|-------|-------|-------|-------|  |-------|-------|-------+-----+-----+-----+-------+-------|
   KC_NUBS,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_UNDS,KC_BSLS,_______,   _______, KC_DEL,KC_PDOT, KC_1, KC_2, KC_3,KC_MINS,KC_RCTL,
//,-------+-------+-------|-------|-------|-------|-------|-------|  |-------|-------|-------|-----------------+-------+-------|
