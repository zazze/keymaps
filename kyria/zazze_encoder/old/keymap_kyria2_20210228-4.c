...
|---+---+---+---+---+---+-------.  ,---+---+---+---+---+---+---+---|
|LCl| Z | X | C | V | B |GUI|Esc|  |RAl|Bsp| N | M | ,<| .>| /?|RSh|
`-----------+---+---+---+---+---|  |---+---+---+---+---+-----------'
            |Lsh|LAl|Spc|LOW|Ent|  |Ent|RSE|Spc|MAC|App|
            `-------------------'  `-------------------'
 */
   [_QWERTY] = LAYOUT( 
//,- ------+-----+-----+------+-----+------.                                     ,-------+-----------+--------+--------+--------+--------.  
...
//,--------|-----|-----|------|-----|------|--------+-------. ,-------|----------|-------|-----------|--------|--------|--------|--------|   
    KC_LCTL, KC_Z, KC_X,  KC_C, KC_V,  KC_B, KC_LGUI, KC_ESC,  KC_RALT,   KC_BSPC,   KC_N,       KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
//,-------------------------------------------------|-------| |-------|----------|-------|-----------|--------|--------+--------+--------,  
                    KC_LSFT,KC_LALT,KC_SPC,MO(_LOWER),KC_ENT,   KC_ENT,MO(_RAISE), KC_SPC,MO(_MACROS), KC_APP
//                 |-------+-------+------+---------+-------, `-------+----------|-------|-----------|--------|
		    ),
...
//,-------|-------|-------|-------|-------|-------|-------|-------|  |-------|-------|-------+-----+-----+-----+-------+-------|
   KC_BSLS,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_UNDS,_______,_______,   _______, KC_DEL,  KC_P0,KC_P1,KC_P2,KC_P3,KC_PEQL,KC_RCTL,
//,-------+-------+-------|-------|-------|-------|-------|-------|  |-------|-------|-------|-----------------+-------+-------|
