...
|---+---+---+---+---+---+-------.  ,---+---+---+---+---+---+---+---|
|LCl| Z | X | C | V | B |GUI|App|  |RAl|Bsp| N | M | ,<| .>| /?|MAC|
`-----------+---+---+---+---+---|  |---+---+---+---+---+-----------'
            |Lsh|Esc|LAl|LOW|Ent|  |Ent|RSE|Spc|RSh|App|
            `-------------------'  `-------------------'
 */
   [_QWERTY] = LAYOUT( 
//,- ------+-----+-----+------+-----+------.                                     ,-------+-------+--------+--------+--------+-----------.  
...
//,--------|-----|-----|------|-----|------|--------+-------. ,-------|----------|-------|-------|--------|--------|--------|-----------|   
    KC_LCTL, KC_Z, KC_X,  KC_C, KC_V,  KC_B, KC_LGUI, KC_APP,  KC_RALT,   KC_BSPC,   KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH,MO(_MACROS),
//,-------------------------------------------------|-------| |-------|----------|-------|-------|--------|--------+--------+-----------,  
                    KC_LSFT,KC_ESC,KC_LALT,MO(_LOWER),KC_ENT,   KC_ENT,MO(_RAISE), KC_SPC,KC_RSFT,KC_APP
//                 |-------+-------+------+----------+------, `-------+----------|-------|-------|--------|
		    ),
